...
Device.prototype.config = function (opts) {
  ...
  if (this.serialosc.debug) {
    var emit = this.oscEmitter.emit;
    this.oscEmitter.emit = function () {
      var args = Array.prototype.slice.call(arguments);
      emit.apply(this.oscEmitter, args);
      console.log('to ' + this.id + ': ' + args.shift());
      console.log(args);
    }.bind(this);
    this.oscReceiver.on('message', function () {
      var args = Array.prototype.slice.call(arguments);
      console.log('from ' + this.id + ': ' + args.shift());
      console.log(args);
    }.bind(this));
  }
};
